...
<div class="page-content-header notification_inner_page clearfix">
    <div class="header-left">
        <h3>{{ $owner->first_name }} {{ $owner->last_name }} accepted your rental request <span>{{ App\Models\Helper::timeDuration($notification->created_at) }}</span></h3>
    </div>
</div>
<div class="listing-of-notification">
    ...
    <div class="btn_holder">
        <ul class="list-unstyled">
            <li><a href="{!! URL('paypal?name='.$product->name.'&price='.$product->price.'&rentID='.$rented->id.'&notificationID='.$notification->id) !!}"  class="">PROCEED TO PAYMENT</a></li>
