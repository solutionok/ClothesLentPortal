                        ...
                        <form id="shipping_calculator">
                            <h2>Shipping Type</h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type">
                                              <option value="Localization">Localization (CANADA)</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col">
                                        <div class="form-group">
                                            ...
                                            <span class="register-error errors" id="shipping_calculator_from_state"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="State" placeholder="State" name="destination_state">
                                            <span class="register-error errors" id="shipping_calculator_destination_state"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col">
                                        <div class="form-group">
